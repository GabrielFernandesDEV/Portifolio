...
$(document).ready(function () {
  ...
  const $projeto2 = $(".projeto2-progress"),
    windowHeightprojeto2 = $(window).height(),
    offsetprojeto2 = windowHeightprojeto2 - windowHeightprojeto2 / 4;
  ...
  function animeScroll() {
    ...
    $projeto2.each(function () {
      if (documentTop > boxTop(this) - offsetprojeto2) {
        addProgress([3, 5]);
      }
    });
